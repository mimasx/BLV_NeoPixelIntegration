...
{   
  ...
  //Serial.println("Duet port started");
    ...
    // Kick off a pattern
    Ring1.ProgressBar(Ring1.Color(50,50,50), Ring1.Color(255,0,0), 100);
    Ring2.Fade(Ring2.Color(50,50,50), Ring2.Color(0,255,0), 10, 100);
    Ring3.ProgressBar(Ring3.Color(50,50,50), Ring3.Color(255,0,0), 100);
}
...
void loop()
{
  ...
  int AmbientTemp=18; //nicer Display of ProgressBars
